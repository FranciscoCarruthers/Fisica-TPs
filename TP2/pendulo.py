...
def main():
    t10, r10, theta10 = get_data('tp2_fisica - angulo_10.csv')
    t15, r15, theta15 = get_data('tp2_fisica - angulo_15.csv')
    t25, r25, theta25 = get_data('tp2_fisica - caso_base.csv')
    t45, r45, theta45 = get_data('tp2_fisica - angulo_45.csv')
    t60, r60, theta60 = get_data('tp2_fisica - angulo_60.csv')
    ...
    tl15, rl15, thetal15 = get_data('tp2_fisica - largo_15.csv')
    tl26, rl26, thetal26 = get_data('tp2_fisica - largo_26.csv')
    ...
    tw5, rw5, thetaw5 = get_data('tp2_fisica - peso_madera.csv')
    tw72, rw72, thetaw72 = get_data('tp2_fisica - peso_oro.csv')
