...
tiempo2 = change_ms_to_s(ms2[14:27]) - 0.5
posicion2 = change_data_to_distance(sensor_data2[14:27]) - 15
errores_y2 = np.full(len(posicion2), 0.44)

tiempo3 = change_ms_to_s(ms3[14:27]) - 0.5
posicion3 = change_data_to_distance(sensor_data3[14:27]) - 15
errores_y3 = np.full(len(posicion3), 0.44)
...
tiempo2 = change_ms_to_s(ms2[3:13]) - 0.7
posicion2 = change_data_to_distance(sensor_data2[3:13]) - 15
errores_y2 = np.full(len(posicion2), 0.44)

tiempo3 = change_ms_to_s(ms3[3:13]) - 0.7
posicion3 = change_data_to_distance(sensor_data3[3:13]) - 15
errores_y3 = np.full(len(posicion3), 0.44)
