...
tiempo2 = change_ms_to_s(ms2[8:17]) - 0.9
posicion2 = change_data_to_distance(sensor_data2[8:17]) - 15
errores_y2 = np.full(len(posicion2), 0.44)

tiempo3 = change_ms_to_s(ms3[8:17]) - 0.9
posicion3 = change_data_to_distance(sensor_data3[8:17]) - 15
errores_y3 = np.full(len(posicion3), 0.44)
...
tiempo2 = change_ms_to_s(ms2[8:14]) - 0.9
posicion2 = change_data_to_distance(sensor_data2[8:14]) - 15
errores_y2 = np.full(len(posicion2), 0.44)

tiempo3 = change_ms_to_s(ms3[8:14]) - 0.9
posicion3 = change_data_to_distance(sensor_data3[8:14]) - 15
errores_y3 = np.full(len(posicion3), 0.44)
...
plt.ylabel('Posición [cm]')
plt.legend()
plt.savefig('TP1/ajuste2_PapelPapelV_O.png')
plt.show()