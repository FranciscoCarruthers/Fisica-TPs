...
aceleracon2 = np.gradient(velocidad2, tiempo2)
aceleracon3 = np.gradient(velocidad3, tiempo3)

# Graficar la derivada numérica
plt.plot(tiempo2, aceleracon2, 'b-', marker='o', label='Derivada numérica 1', color='red')
plt.plot(tiempo3, aceleracon3, 'b-', marker='o', label='Derivada numérica 2', color='blue')
plt.xlabel('Tiempo [s]')
