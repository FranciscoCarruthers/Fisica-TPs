...
ms3 , sensor_data3 = get_data_from_file('TP1/Mediciones Fisica/piso hoja/M_OP-3.csv')

tiempo2 = change_ms_to_s(ms2[5:14]) - 0.6
posicion2 = change_data_to_distance(sensor_data2[5:14]) - 15
errores_y2 = np.full(len(posicion2), 0.44)

tiempo3 = change_ms_to_s(ms3[5:14]) - 0.6
posicion3 = change_data_to_distance(sensor_data3[5:14]) - 15
errores_y3 = np.full(len(posicion3), 0.44)
...
ms3 , sensor_data3 = get_data_from_file('TP1/Mediciones Fisica/piso hoja/V_2P-2.csv')

tiempo2 = change_ms_to_s(ms2[4:14]) - 0.5
posicion2 = change_data_to_distance(sensor_data2[4:14]) - 15
errores_y2 = np.full(len(posicion2), 0.44)

tiempo3 = change_ms_to_s(ms3[4:14]) - 0.5
posicion3 = change_data_to_distance(sensor_data3[4:14]) - 15
errores_y3 = np.full(len(posicion3), 0.44)
...
plt.ylabel('Posición [cm]')
plt.legend()
plt.savefig('TP1/ajuste2_PisoHojaV_2P.png')
plt.show()